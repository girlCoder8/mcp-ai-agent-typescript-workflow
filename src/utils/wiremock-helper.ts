...
export class WiremockHelper {
    ...
    static async waitForWiremock(maxAttempts: number = 30, intervalMs: number = 1000): Promise<void> {
        console.log(`Waiting for Wiremock server to be ready (max ${maxAttempts} attempts)...`);
        ...
        throw new Error(`Wiremock server did not become ready within ${maxAttempts * intervalMs / 1000} seconds`);
    }
